...
CUDA_VISIBLE_DEVICES=5 python train_fl32.py config/train_shakespeare_char.py --opt_name=sgd_hdn_adagrad --learning_rate=1e-2 --decay_lr=False --hyper_lr=1e-3 --wandb_log=True &
